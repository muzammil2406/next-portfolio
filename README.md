![Portfolio](https://res.cloudinary.com/dxbpsbhbg/image/upload/v1750578180/sqfdw_wozlmn.png)
)
)
...
1. Fork [this](https://github.com/muzammil2406/next-portfolio) repository.
...
1. Update the sample [data.json](https://github.com/muzammil2406/next-portfolio/blob/main/data.json) provided, with your data or directly import the same and edit using firebase later. (For storing images you can use [Cloudinary](https://cloudinary.com) or [Firebase Storage](https://firebase.google.com/docs/storage))

2. Import json data

   - Go to [Firebase Console](https://console.firebase.google.com) and select your project
   - Go to "Database" -> "Realtime Database" -> "Import JSON" and import the [data.json](https://github.com/muzammil2406/next-portfolio/blob/main/data.json) file
...
This project is licensed under the MIT License - see the [LICENSE.md](https://github.com/muzammil2406/next-portfolio/blob/main/LICENSE.md)
